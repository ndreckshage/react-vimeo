...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Vimeo = function (_React$Component) {
	  _inherits(Vimeo, _React$Component);
	  ...
	  function Vimeo() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Vimeo.__proto__ || Object.getPrototypeOf(Vimeo)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      imageLoaded: false,
	      playerOrigin: '*',
	      showingVideo: _this.props.autoplay,
	      thumb: null
	    }, _this.mounted = false, _this.setMountedState = function (state) {
	      if (_this.mounted) {
	      ...
	      if (data.event === 'ready') {
	        ...
	        debug('player ready');
	        _this.onReady(player, playerOrigin === '*' ? origin : playerOrigin);
	        return onReady(data);
	      }
	      if (!data.event) {
	      ...
	      e.preventDefault();
	      _this.setMountedState({ showingVideo: true });
	...
	Vimeo.defaultProps = _extends({}, Object.keys(playerEvents).concat(['ready']).reduce(function (defaults, event) {
